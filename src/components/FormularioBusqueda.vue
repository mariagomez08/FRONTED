...
export default {
  ...
  methods: {
    ...
    buscar() {
      ...
      axios.get("http://localhost:3000/api/busqueda/tipo/" + this.peticion ).then((result) => {//Dentro de la variable result hay información sobre la petición y para recuperar el resultado tenemos que acceder al campo data.
